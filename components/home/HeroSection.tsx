...
>>>>>>> e76fbe2ba247adddef444155d6e3fa40483d1aaf
...
export default function HeroSection() {
  ...
  const stats = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#2D5F2E]" aria-hidden="true">
          <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" />
        </svg>
      ),
      value: "25+",
      label: tr.hero_stat_years,
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#2D5F2E]" aria-hidden="true">
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col -mt-20 overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 pt-28 pb-0">
        <h1 className="font-black text-white leading-none mb-6" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(48px, 8vw, 96px)", lineHeight: 0.95 }}>
          {tr.hero_headline1}
          <br />
          {tr.hero_headline2}
        </h1>

        <p className="font-serif italic text-[#D4A574] mb-8" style={{ fontSize: "clamp(28px, 5vw, 56px)", lineHeight: 1.2 }}>
          {tr.hero_tagline}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/products" className="bg-[#2D5F2E] text-white px-9 py-4 rounded-xl font-bold text-sm hover:bg-[#1e4520] active:scale-95 transition-all flex items-center justify-center gap-2 group shadow-xl">
            {tr.hero_cta_explore}
          ...
          <Link href="/contact" className="border-2 border-white/40 text-white px-9 py-4 rounded-xl font-bold text-sm hover:bg-white hover:text-[#2D5F2E] active:scale-95 transition-all backdrop-blur-sm">
            {tr.hero_cta_contact}
          </Link>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 grid grid-cols-2 md:grid-cols-4 divide-y divide-x-0 md:divide-x md:divide-y-0 divide-gray-100 overflow-hidden">
          {stats.map((stat) => (
            <div key={stat.label} className="flex flex-col items-center text-center p-6">
              ...
              <div className="text-4xl font-black text-[#2D5F2E] mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>
                {stat.value}
              </div>
