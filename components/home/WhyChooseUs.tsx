...
export default function WhyChooseUs() {
  ...
  const features = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#D4A574]" aria-hidden="true">
          <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" />
          <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12" />
        </svg>
      ),
      title: tr.wcu_f1_title,
      description: tr.wcu_f1_desc,
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#D4A574]" aria-hidden="true">
      ...
      title: tr.wcu_f2_title,
      description: tr.wcu_f2_desc,
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#D4A574]" aria-hidden="true">
      ...
      title: tr.wcu_f3_title,
      description: tr.wcu_f3_desc,
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#D4A574]" aria-hidden="true">
      ...
      title: tr.wcu_f4_title,
      description: tr.wcu_f4_desc,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <div className="lg:flex items-end justify-between mb-16 gap-8">
          <div>
            ...
            <h2 className="font-black text-white leading-tight" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(32px, 5vw, 52px)" }}>
              {tr.wcu_title1}
              <br />
              {tr.wcu_title2}
            </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature) => (
            <div key={feature.title} className="bg-white/[0.08] hover:bg-white/[0.15] border border-white/10 hover:border-white/20 rounded-2xl p-7 transition-all duration-300 cursor-default group">
